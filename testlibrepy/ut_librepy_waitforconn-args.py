"""
This unit test checks the argument checking for waitforconn().
"""
...
try:
  stop_func = waitforconn(12345.0, noop)
  stop_func()
...
# Try a bad localip
try:
  stop_func = waitforconn(12345, noop, "321.123.444.555")
  stop_func()
...
try:
  stop_func = waitforconn(12345, noop, "hi there")
  stop_func()
...
try:
  stop_func = waitforconn(12345, noop, check_intv=-1)
  stop_func()
...
try:
  stop_func = waitforconn(12345, noop, check_intv=0)
  stop_func()
...
try:
  stop_func = waitforconn(12345, noop, thread_pool="test")
  stop_func()
