...
This script tests if some comments(include some_lib.repy # Ensure that 
comments are ignored, even if preceded by whitespace) are ignored.
"""
...
def main():
  ...
  pass
'''
    filecontent2 = '''include testfile_repypp_example1.repy # Ensure that comments are ignored, even if preceded by whitespace
def bar():
  pass
'''
